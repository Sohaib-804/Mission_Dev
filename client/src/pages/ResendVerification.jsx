...
function ResendVerification() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus("error")
      setMessage(error.response?.data?.msg || "Failed to resend verification email. Please try again.")
    }
  }
        ...
        >
          <div className="w-full h-full flex flex-col justify-end bg-gradient-to-t from-black/70 to-transparent p-12">
            <div className="max-w-md">
              <h2 className="text-4xl font-bold text-white mb-4">Verify your email to access all features.</h2>
              <div className="mt-6">
